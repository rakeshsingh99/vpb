...
<div class="loginback">
        <div>
			<h3 class="page-title">
				Add Supplier Invoice <small>here we can add supplier bill details</small>
			</h3>
			<ul class="breadcrumb">
				<li><i class="icon-home"></i> <a href="userHomeDef.jsp">Home</a>
					<span class="icon-angle-right"></span></li>
				<li><a href="listofsuppliers.vpb">Suppliers List</a> <span
					class="icon-angle-right"></span></li>
				<li><a href="#">Add Invoice</a></li>
			</ul>
		</div>
<div align="center">
<form action="addSupplierBill.vpb" class="register" method="post">		
               ...
               <table  class="textStyle form" align="center">
                  <tbody>
                    <tr>
                      <p>
						 <td>
							<label style=" for="BX_publication"><b>Bill Date</b></label>
						 </td>
						 <td>	
							<input type="text" id="selector" required="required" name="billdate" readonly>
						</td>
						</p>
					...
					<tr>
                      <p>
						 <td>
							<label style=" for="BX_publication">Bill Number</label>
						 </td>
						 <td>	
							<input type="text"  required="required" name="billnumber">
						</td>
					...
					<tr>	 
					   ...
					   <td>
							<label style="for="BX_quantity">Bill Amount</label>
					   </td>
						 <td>		
							<input type="text"  required="required" name="billamount">
					   </td>				   
                    ...
                    <tr>
					   ...
					   <td>
							<label style="for="BX_quantity">Amount Paid</label>
					   </td>
						 <td>		
							<input type="text"  required="required" name="amountpaid">
					   </td>				   
                    ...
                    <tr>
					   ...
					   <td>
							<label style="for="BX_quantity">Return Amount</label>
					   </td>
						 <td>		
							<input type="text"  required="required" name="returnAmount">
					   </td>				   
                ...
                <td colspan="5" align="center">
                        <input type="hidden" value="${SUPPLIER_NAME }" name="supplierName"/>
                        <input class="btn blue" type="submit" value="Add Invoice &raquo;"/>
                    </td></tr> 
                </table>
				<div class="clear"></div>
