...
<body>
	<div class="loginback">
		<div>
			<h3 class="page-title">
				Add Payment <small>here we can add payment details made to the supplier</small>
			</h3>
			<ul class="breadcrumb">
		...
		<div align="center">
			<form action="addSupplierCash.vpb" class="register" method="post">
				...
				<table>
					<tr>
						<td colspan="5" align="center"><input type="hidden"
							value="${SUPPLIER_NAME }" name="supplierName" /> <input class="btn blue"
