...
<div>
<h3 class="page-title">
							Register Customer <small>Here we can register the details of new customer we want to deal with</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
...
<tr bgcolor="#404040">
	<td  align="center" colspan="6">
		<font style="float:center; font-size:120%;" color="white"><b> Register New Customer </b></font>
		<a style="float:right; font-size:120%;" class="btn blue" href="listofcustomers.vpb">Back</a>
		</td>
</tr>
</table>
...
<tr>
	<td>
		<label style=" for="BX_publication">Shop Name</label>	
	</td>
	<td>
		<input type="text"  required="required" name="shname">
    </td>
	<td>
		<b><font color="red"><nitesh:error property="shname"/> </font></b>
    </td>
</tr>
...
<tr>
	<td>
		<label style=" for="BX_publication">Username</label>	
	</td>
	<td>
		<input type="text"  required="required" name="uname">
    </td>
	<td>
		<b><font color="red"><nitesh:error property="uname"/> </font></b>
    </td>
</tr>
...
<tr>
	<td>
		<label style=" for="BX_publication">Password</label>	
	</td>
	<td>
		<input type="password"  required="required" name="pass">
    </td>
	<td>
		<b><font color="red"><nitesh:error property="pass"/> </font></b>
    </td>
</tr>
