...
<div>
<h3 class="page-title" >
							Add Bill <small >here we can add manual bill details</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
...
<div align="center">
<form action="addBill.vpb" class="register" method="post">		
               ...
               <table  class="textStyle form" align="center">
                ...
                <td colspan="5" align="center">
                        ...
                        <input class="btn blue" type="submit" value="Add Bill &raquo;"/>
                    </td></tr> 
                </table>
				<div class="clear"></div>
